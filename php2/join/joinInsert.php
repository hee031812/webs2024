                    ...
                    <form action="joinResult.php" name="joinResult" method="post" onsubmit="return joinChecks();">
                        <fieldset>
                            ...
                            <div class="join">
                                ...
                                <div class="check">
                                    <input type="text" id="youId" name="youId" placeholder="아이디를 적어주세요!"
                                        class="input__style">
                            ...
                            <div class="join">
                                ...
                                <input type="text" id="youPhone" name="youPhone" placeholder="연락처는 공백없이 적어주세요!"
                                    class="input__style">
        ...
        function searchBtnClick() {
            new daum
                ...
                */
                        ...
                        document
                            .querySelector('#youAddress1')
                            .value = data.zonecode; // 우편번호
                        document
                            .querySelector("#youAddress2")
                            .value = addr; // 주소
                        document
                            .querySelector("#youAddress3")
                            .focus();
