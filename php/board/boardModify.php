...
<body class="gray">
    ...
    <main id="main" role="main">
        <div class="intro__inner conteiner bmStyle">
            <div class="intro__img small">
                <img srcset="../asset/img/intro03-min.jpg 1x, ../asset/img/intro03-min@2x-min.jpg 2x, ../asset/img/intro03-min@3x-min.jpg 3x" alt="인트로 이미지">
            </div>
