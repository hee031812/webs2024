...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/firstmain.css">
    <!-- css -->
    <link href="https://webfontworld.github.io/vitro/VitroPride.css" rel="stylesheet">
    <!-- font -->
    <style>
        ...
        .universe-container {
            width: 100%;
            height: 100%;
            background-image: radial-gradient(1600px at 70% 120%, #212750 10%, #020409 80%);
        }
...
<body>
    <nav class="main-nav">
        <i class="fa fa-circle" aria-label="Main"></i>
        <i class="fa fa-circle" aria-label="How It Works"></i>
        <i class="fa fa-circle" aria-hidden="Contact"></i>
    </nav>

    <div class="main-page page">
        <section class="main-page-content">
            <h1>Think about the futuer</h1>
            <h2>save the world by recycling</h2>
        </section>
    </div>
    ...
    <main id="parallax__cont">
        <section id="section7" class="parallax__item">
            <span class="parallax__item__num"></span>
            <div class="parallax__item__text t1">하루평균 배출되는 쓰레기 양</div>
            <div class="parallax__item__text t2">50만톤</div>
            <div class="parallax__item__text t3">나의 작은 실천으로</div>
            <div class="parallax__item__text t4">지구를 살려주세요.</div>
            <div class="parallax__item__text t5">분리배출 방법을 정확히 알고있다면</div>
            <div class="parallax__item__text t6">누구나 지구를 살릴수있습니다.</div>
        </section>
    </main>
    <!-- //Scroll Section7 -->
    <div class="clickMe">
        <a href="#" class="cta">
            <a href="../main/main.php"><span>Click me</span></a>
    ...
    <script src="../gsap/js/common.js"></script>
    ...
    <script>
        ...
        ani7.from("#section7 .t1", { autoAlpha: 0, duration: 1, y: 80 }, "+=1")
        ani7.from("#section7 .t2", { autoAlpha: 0, duration: 1, y: 80 }, "+=1")
        ani7.from("#section7 .t3", { autoAlpha: 0, duration: 1, y: 80 }, "+=1")
        ani7.from("#section7 .t4", { autoAlpha: 0, duration: 1, y: 80 }, "+=1")
        ani7.from("#section7 .t5", { autoAlpha: 0, duration: 1, y: 80 }, "+=1")
        ani7.from("#section7 .t6", { autoAlpha: 0, duration: 1, y: 80 }, "+=1")
        ani7.from("#section7 .t7", { autoAlpha: 0, duration: 1, y: 80 }, "+=1")
